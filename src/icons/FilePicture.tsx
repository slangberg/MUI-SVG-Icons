...
const SvgFilePicture = createSvgIcon(
  React.createElement(
    React.Fragment,
    null,
    <path d="M19.5 21h-15v-3L9 10.5l6.164 7.5 4.336-3v6zM19.5 11.25a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0z" />,
